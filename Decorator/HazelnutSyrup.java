...
// This declares the class 'HazelnutSyrup' and uses the key word/statement 'extends' to 
...
public class HazelnutSyrup extends CoffeeDecorator {

    // This is the constructor that will create the object 'newCoffee'.
    public HazelnutSyrup(Coffee newCoffee) {
        // This uses the 'super' keyword/statement to initialise the constructor by
        // calling the super class CoffeeDecorator.
        super(newCoffee);
        // This outputs the text 'Added Hazelnut Syrup'
        System.out.println("Added Hazelnut Syrup   £" + price);
    }
    ...
    public String getDescription() {
        ...
        // from the object 'coffeeCup' and adds the string value '", Hazelnut Syrup"' to
        // the accumulating value, then returns the value.
        return coffeeCup.getDescription() + ", Hazelnut Syrup";
    }
