...
// This declares the class 'GingerbreadSyrup' and uses the key word/statement 'extends' to 
...
public class GingerbreadSyrup extends CoffeeDecorator {

    // This is the constructor that will create the object 'newCoffee'.
    public GingerbreadSyrup(Coffee newCoffee) {
        // This uses the 'super' keyword/statement to initialise the constructor by
        // calling the super class CoffeeDecorator.
        super(newCoffee);
        // This outputs the text 'Added Gingerbread Syrup'
        System.out.println("Added Gingerbread Syrup   £" + price);
    }
    ...
    public String getDescription() {
        ...
        // from the object 'coffeeCup' and adds the string value '", Gingerbread Syrup"'
        // to the accumulating value, then returns the value.
        return coffeeCup.getDescription() + ", Gingerbread Syrup";
    }
