...
// This declares the class 'SteamedMilk' and uses the key word/statement 'extends' to 
...
public class SteamedMilk extends CoffeeDecorator {
    ...
    public SteamedMilk(Coffee newCoffee) {
        ...
        super(newCoffee);
        // This outputs the text 'Added Espresso'
        System.out.println("Added Espresso   £2.50");
        // This outputs the text 'Added Steamed Milk'
        System.out.println("Added Steamed Milk   £" + price);
    }
    ...
    public String getDescription() {
        ...
        // from the object 'coffeeCup' and adds the string value '", Steamed Milk"' to
        // the accumulating value, then returns the value.
        return coffeeCup.getDescription() + ", Steamed Milk";
    }
    ...
    public double getCost() {
        ...
        // from the object 'coffeeCup' and adds the double value '3.00' to the
