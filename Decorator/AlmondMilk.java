...
// This declares the class 'AlmondMilk' and uses the key word/statement 'extends' to 
...
public class AlmondMilk extends CoffeeDecorator {
    ...
    public AlmondMilk(Coffee newCoffee) {
        // This uses the 'super' keyword/statement to initialise the constructor by
        // calling the super class CoffeeDecorator.
        super(newCoffee);
        // This outputs the text 'Added AlmondMilk'
        System.out.println("Added Almond Milk   £" + price);
    }
    ...
    public String getDescription() {
        ...
        // from the object 'coffeeCup' and adds the string value '", Almond Milk"' to
        // the accumulating value, then returns the value.
        return coffeeCup.getDescription() + ", Almond Milk";
    }
